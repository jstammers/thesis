...
in~\SectionRef{sec:pulse_characterisation}. This chapter continues
...
\section{The M-Squared Laser System}\label{sec:msquared_laser} 
  ...
  in~\SectionRef{subsec:dcs_module} with a description of the module used to control
...
The output light frequency is stabilised using piezo-electric stacks to adjust
...
\subsection{The DCS Module}\label{subsec:dcs_module} The DCS module is used to control the
...
collimator. 
  \begin{figure}[!htpb]
    ...
    \caption[Scheme for detection by driving \(\sigma^+\)
    transitions.]{Scheme for detection by driving \(\sigma^+\) transitions. A
...
\begin{figure}[!htbp]
	...
	\subfloat[][]{\scalebox{0.3}{\includegraphics{light_shift_ratio}}\label{fig:light_shift_ratio}}
\subfloat[][]{\scalebox{0.3}{\includegraphics{light_shift_detuning}}\label{fig:light_shift_detuning}}\\
...
\begin{figure}[htpb!]
  \centering
  \subfloat[][]{\scalebox{0.5}{\includegraphics{low_vib_hist_mems_atom}}\label{fig:low_vib_hist_mems_atom}}
    \subfloat[][]{\scalebox{0.5}{\includegraphics{low_vib_hist_atom_res}}\label{fig:low_vib_hist_atom_res}}
