...
\usepackage{tikz}
\usepackage{multirow}
%\usepackage[backend=biber,url=false, defernumbers=true]{biblatex}
\usepackage{cite}
...
%chktex-file 1
%disable warning about group pages
...
\hypersetup{%
pdftitle = {An Atom Interferometer for Measuring Horizontal
Accelerations},
