...
2\pi/$(\sivalue{780}{\nm}). For an atom falling under
gravity located
between the output of the collimator and the retro-reflecting mirror
such that $z_0 = L =$ \sivalue{7.5}{\cm}, a divergence angle of
$\theta =$ \sivalue{1}{\milli\radian} contributes
\sivalue{8e-12}{\radian} to the
interferometer phase for a pulse separation of $T=$
\sivalue{25}{\milli\s}. Provided that the beams are reasonably
...
=$ \sivalue{100}{\nano\g} results from a Raman phase gradient of
$\alpha = $ \sivalue{1.6}{\radian\per\metre} and corresponds to a tilt
of the retro-reflecting mirror of \sivalue{0.1}{\micro\radian}.
\SectionRef{sec:in_situ} describes a method
