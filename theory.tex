...
\begin{equation}
  ...
  \begin{pmatrix}
    ...
    \Omega_\textnormal{eff}^*&  -\delta - \Omega_2^\textnormal{ac}  \\
...
\frac{|\Omega_{1k}| |\Omega_{2k}|}{4\Delta_k}
\end{equation}
